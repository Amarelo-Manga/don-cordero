...
$image_pratos = get_field('imagem_de_tipo_de_pratos', $taxonomy . '_' . $term_id); ?>
	...
	<div class="container">
		<div class="row" style="display: flex;"> <!--span class="call_to_action2">Cardápio Completo</span--> </div>
	</div>
</section>
		...
		<div class="row" style="display: flex;">
			<div id="happy_hour" class="col-lg-6 col-md-12 col-sm-12">
				<div class="row content_happy">
					<div class="col-lg-4 d-block d-lg-block d-md-none"></div>
			...
			<div class="col-lg-6 col-md-12 col-sm-12" style="padding: 0; margin: 0;">
				<div class="cortes_area row">
					<div class="col-lg-8 col-md-7 col-sm-6">
						<h2><span class="hand">Cortes</span><br>
              ESPECIAIS</h2>
					</div>
...
<section class="cozinha">
	<div class="container-fluid">
		<div class="container">
			<div class="row" style="display: flex;">
				<div class="col-lg-8">
					<h2><span class="hand">Uma cozinha com</span> <br>
            INGREDIENTES SELECIONADOS</h2>
