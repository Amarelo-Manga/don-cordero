<footer class="container-fluid ">
  ...
  <div class="row" style="display: flex;">
    <div class="col-lg-6 col-md-6 col-sm-6 maps">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 address">
      <h2> <span class="hand">Venha nos</span><br>
        VISITAR</h2>
      <ul>
        <li><img src="<?php echo get_template_directory_uri()?>/img/facebook-placeholder-for-locate-places-on-maps.png" class="icon_footer"><div class="address_data">Av. Aparecida Tellau Seraphim, 1.800<br>
          Vinhedo . São Paulo<br>
          CEP: 13280.000 </div></li>
        <li> <img src="<?php echo get_template_directory_uri()?>/img/phone-receiver.png" class="icon_footer"><div class="address_data">19 3826.2163 / 2301 / 2054<br>
          19 3876.0421 </div></li>
        <li><img src="<?php echo get_template_directory_uri()?>/img/mail-black-envelope-symbol.png" class="icon_footer">reservas@doncordero.com.br</li>
        <li> <img src="<?php echo get_template_directory_uri()?>/img/clock-circular-outline.png" class="icon_footer"><div class="address_data">
...
<link href="<?php echo get_template_directory_uri()?>/jQueryAssets/jquery.ui.core.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo get_template_directory_uri()?>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo get_template_directory_uri()?>/jQueryAssets/jquery.ui.tabs.min.css" rel="stylesheet" type="text/css">
</html>